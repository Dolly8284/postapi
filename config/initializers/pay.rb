Pay.setup do |config|
  ...
  config.business_name = "PD Nasyidah"
  config.business_address = "Ds. Surapati No. 36, Samarinda  "
  config.application_name = "Bilemobile"
  config.support_email = "mayasari.gamblang@maulana.com"
